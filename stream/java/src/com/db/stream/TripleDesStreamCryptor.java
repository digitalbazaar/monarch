 ...
 * using the TripleDES "DESsede" algorithm.
 * 
 * @author Dave Longley
 */
public class TripleDesStreamCryptor extends StreamCryptor
{
      ...
      throws IllegalArgumentException
   {
      ...
      // generate a DESsede key for the encryption and decryption
      getCryptor().generateInternalKey("DESsede");
   }
      ...
      if(encodedKey != null)
      {
         try
         {
            ...
            SecretKeyFactory keyFactory =
               SecretKeyFactory.getInstance("DESsede");
