...
/**
 * A SecureWebConnectionServicer is an extension to a WebConnectionServicer
 * that provides a method for running security checks on web connections.
 * 
 * @author Dave Longley
 */
public interface SecureWebConnectionServicer extends WebConnectionServicer
{
   /**
