      ...
      if(fiber != NULL)
      {
         ...
         switch(i->state)
         {
            ...
            case Fiber::Interrupted:
               // add state, fiber thread work unchanged
               fiber->setState(state | i->state);
               break;
            case Fiber::Wakeup:
