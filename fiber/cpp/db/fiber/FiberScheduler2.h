 ...
 */
#ifndef db_fiber_FiberScheduler2_H
#define db_fiber_FiberScheduler2_H
 ...
 * @author Dave Longley
 */
class FiberScheduler2 : public db::rt::Runnable
{
protected:
   /**
    ...
    */
   typedef std::map<FiberId2, Fiber2*> FiberMap;
   FiberMap mFiberMap;
   
   /**
    * A queue of fibers to execute.
    */
   typedef std::list<Fiber2*> FiberQueue;
...
public:
    ...
    */
   virtual FiberId2 addFiber(Fiber2* fiber);
    ...
    */
   virtual void yield(Fiber2* fiber);
    ...
    */
   virtual void sleep(Fiber2* fiber);
    ...
    */
   virtual void wakeup(FiberId2 id);
    ...
    */
   virtual void exit(Fiber2* fiber);
