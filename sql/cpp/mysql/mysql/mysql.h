...
// this must also work under a MING32 compiler -- and
// __MING32__ wasn't defined for some reason so i just
...
#include "mysql/my_list.h" /* for LISTs used in 'MYSQL' and 'MYSQL_STMT' */
