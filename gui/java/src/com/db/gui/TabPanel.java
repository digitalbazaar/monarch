...
public class TabPanel extends JPanel
{
   ...
   protected void createLeftTabScrollButton()
   {
      ...
      mLeftScrollButton =
         new ColoredBasicArrowButton(BasicArrowButton.WEST,
   ...
   protected void createRightTabScrollButton()
   {
      ...
      mRightScrollButton =
         new ColoredBasicArrowButton(BasicArrowButton.EAST,
               getSelectedColor(), getShadowColor(),
               getDarkShadowColor(), getHighlightColor());      
   ...
   public class ColoredBasicArrowButton extends BasicArrowButton
   {
      ...
      public ColoredBasicArrowButton(
         int direction, Color background, Color shadow,
         Color darkShadow, Color highlight)
      {
         this(direction, background, shadow, darkShadow, highlight,
