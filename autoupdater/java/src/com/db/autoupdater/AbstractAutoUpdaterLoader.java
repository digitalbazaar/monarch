 ...
 * @author Dave Longley
 */
public abstract class AbstractAutoUpdaterLoader implements AutoUpdaterLoader
{
   /**
    ...
    */
   public AbstractAutoUpdaterLoader()
   {
   ...
   /**
    * Loads an AbstractAutoUpdater.
    * 
    * @return the loaded AbstractAutoUpdater.
    */
   public AutoUpdater loadAutoUpdater()
   {
      return loadAbstractAutoUpdater();
   }
   
   /**
    * Loads an AbstractAutoUpdater. This method must return an
    * Abstract
    * 
    * @return the loaded AutoUpdater.
    */
   public abstract AbstractAutoUpdater loadAbstractAutoUpdater();
   ...
   public void runAutoUpdater(String configFilename, String[] args)
   {
      ...
      {
         // load AutoUpdater
         AbstractAutoUpdater updater = loadAbstractAutoUpdater();
         if(updater != null)
         {
