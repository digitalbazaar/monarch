...
public class Wsdl extends AbstractXmlSerializer
{
    ...
    */
   public Wsdl(String name, String namespace, Class portTypeInterface)
   {
      ...
      // generate WSDL
      generateWsdl(portTypeInterface);
   }
    ...
    * @param portTypeInterface an interface for a port type.
    */
   protected void generateWsdl(Class portTypeInterface)
   {
      ...
      // create and add a soap binding
      WsdlSoapBinding binding = new WsdlSoapBinding(
         this, portType.getName() + "SoapBinding", portType);
      getBindings().add(binding);
      
      // create a service
      WsdlService service = new WsdlService(this, getName());
      
      // create a soap port and add it to the service
      WsdlSoapPort port =
         new WsdlSoapPort(binding, portType.getName() + "Port");
