...
void runTemplateParserTest(TestRunner& tr)
{
   tr.test("runTemplateParserTest");
   {
      // create template
      const char* tpl =
         "Subject: This is an autogenerated unit test email\r\n"
...
public:
   ...
   {
      // FIXME: move me above template parser test
